...
* We implemented login, register, forgot password and delete account endpoints.
* We decided on a color palette for the application.
* We implemented login, register, forgot password and delete account for web application.
* We implemented the main layout for the web pages
* We implemented login, register, forgot password and delete account for mobile application.
* We implemented the main layout of the pages for mobile application.
* We will implement game detail and games page related endpoints.
* We will implement game page and detail web pages.
* We will implement game page and detail for mobile application.
...
| Game Page Mockup Review - MOBILE  | [#454](https://github.com/bounswe/bounswe2023group5/issues/454) | Mobile Team | 24.10.2023 |  | 2 hr | 3 hr |
| Initializing README document for Mobile - MOBILE  | [#455](https://github.com/bounswe/bounswe2023group5/issues/455) | Mobile Team | 31.10.2023 |  | 2 hr | - |
...
## Planned vs. Actual
- We'd decided to not implement logout endpoint in backend and implement it in frontend. 
- We implemented a different change password endpoint for forgot password situation.
- We started to connect frontend pages to backend but we cannot finished it.
- We cannot review and update the game mockups.
...
| Tag Implementation in Game  | [#538](https://github.com/bounswe/bounswe2023group5/issues/538)| Can Uzduran | 31.10.2023 | 4 hr | 
| Vote Implementation | [#532](https://github.com/bounswe/bounswe2023group5/issues/532)| Can Uzduran | 31.10.2023 | 4 hr | 
| Adding Conventions to Wiki Page| [#517](https://github.com/bounswe/bounswe2023group5/issues/517) | Alperen Bırçak | 31.10.2023 | 30 mins | 
| Updating RAM | [#518](https://github.com/bounswe/bounswe2023group5/issues/518) [#526](https://github.com/bounswe/bounswe2023group5/issues/526), [#534](https://github.com/bounswe/bounswe2023group5/issues/534) [#535](https://github.com/bounswe/bounswe2023group5/issues/535) [#536](https://github.com/bounswe/bounswe2023group5/issues/536) | Team | 31.10.2023 | 30 mins |
