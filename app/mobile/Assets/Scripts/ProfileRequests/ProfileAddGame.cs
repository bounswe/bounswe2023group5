...
public class ProfileAddGame : MonoBehaviour
{
    ...
    public void Init()
    {
        string url = AppVariables.HttpServerUrl + "/profile/add-game" +
    ...
    IEnumerator Post(string url, string bodyJsonString)
    {
        ...
        if (request.responseCode == 200)
        {
            ...
            Debug.Log("Success to add game: " + response);
        }
        else
        {
            Debug.Log("Error to add game: " + response);
        }
